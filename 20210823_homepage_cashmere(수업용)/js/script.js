...
var $c_box_frame = document.querySelector("#cont_01 article:first-child .content");
console.log($c_box_frame);
...
//#4. 1차 배열 데이터의 개수만큼 구조를 반복하면서 각 반복하는 순서에 따라 배열 데이터의 내용을 담아서 
for(i = 0; i < $cont_01.length; i++){
    $c_box_01 += `
    <div class="cont_box">
...
$c_box_frame.innerHTML = $c_box_01;  //최종 세개의 .cont_box를 묶어서 .content 하위에 넣어주겠다는 의미



///////////////////////////////////////////////////
//#1. 배열 데이터 구성
//2차 배열 객체 패턴 ["이미지파일명", "타이틀", "내용"]
var $cont_02 = [
        {$img:"story_02.jpg",
        $title:"Pure cotton that everyone is happy",
        $cont:"In principle, fair trade aims to improve producers' lives and become independent by providing jobs to those who are socially and economically vulnerable and purchasing raw materials and products at an appropriate price. When you make products with the right organic products rather than to support someone, the relationship of fair trade is naturally formed."},
        {$img:"story_03.jpg",
        $title:"Precision in consideration of ecology",
        $cont:"We produce products that reflect the most up-to-date information such as new construction methods, environmental changes, farmland environments, and the global trend of the organic movement. We believe that organic fabrics made through these efforts can be recognized for their precise and reliable quality."},
];
console.log($cont_02);
